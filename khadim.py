...
from concurrent.futures import ThreadPoolExecutor as khadimssb
from string import * 
...
\033[1;37m    ######      ######     ########  
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Muhammad khadim
\033[1;37m Facebook:            Muhammad khadim
\033[1;37m Github  :            khadim-Ssb
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with khadimssb(max_workers=30) as ssbworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
...
def cutter():
    ...
    os.system('sort -r '+ssb+' | uniq > '+khadim)
    os.system('clear')
    print(logo)
